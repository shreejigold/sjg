         ...
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
               ...
               <div className="flex gap-6">
                  ...
                  <a href="mailto:shreejigold02@gmail.com" className="text-zinc-500 hover:text-[#5B3E29] transition-colors" aria-label="Email">
                     <Mail size={20} />
                  </a>
               </div>
            </div>
            ...
            <div>
               ...
               <ul className="space-y-4 text-xs text-zinc-400">
                  ...
                  <li className="flex items-center gap-3"><Phone size={14} className="text-gold" /> +91 88086 88002</li>
                  <li className="flex items-center gap-3"><Mail size={14} className="text-gold" /> shreejigold02@gmail.com</li>
